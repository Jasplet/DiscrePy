        ...
        for ch in channel:
            ...
            if os.path.isfile(id_tst) == True:
                ...
                try:
                    ...
                    no_dat = no_dat + 1 #Counter for number of events where no data was available


    #print("Download attempts finished. No data was available for ",no_dat, "of", no_events,"events. ",too_short, "events had incomplete traces which were not saved")
############## End of Function to Request and Save Traces ####################


### Start of Main script ####
data = pd.read_csv("/Users/ja17375/Scripts/Python/SKS_Splitting/Jacks_SKS_RAW.txt",delim_whitespace=True)
