        ...
        for line in reader.readlines():
            ...
            if st != False and len(st) is 3: # i.e. if the stream is sufficiently populated and has been read.
                ...
                if switch is 'on':
                    ...
                    eig_file ='{}/{}/{}/{}_{:07d}_{:06d}.eigm'.format('/Users/ja17375/DiscrePy/Python/Eigm_Files',phase,station,station,date,time)
                elif switch is 'off':
                    eig_file = '{}/{}/{}/{}_{}_{:07d}_{:06d}'.format('/Users/ja17375/DiscrePy/Python/Eigm_Files',phase,station,station,'JW_Windows',date,time)
                ...
                if os.path.isfile(eig_file):
                    ...
                    if switch == 'on': # If manual windowing is on
                        ...
                        if phase == 'SKKS' and st[0].stats.sac.gcarc < 105.0:
                            ...
                            plt.savefig('{}{}_{}_{:07d}_{:06d}'.format('/Users/ja17375/DiscrePy/Python/Figures/Eigm_Surface/',station,phase,date,time))
                            plt.close()
                            write_splitting(outfile,station,phase,eigm=split,st=st,date=date,time=time)
                            split.save(eig_file)
                        ...
                        plt.savefig('{}/{}_{}_{}_{:07d}_{:06d}'.format('/Users/ja17375/DiscrePy/Python/Figures/Eigm_Surface',station,phase,'JW_Windows',date,time))
...
def output_init(station,switch,phase):
    ...
    if switch is 'on':
        ...
        default_out = '/Users/ja17375/DiscrePy/Python/Measurements/{}_{}_Splitting.txt'.format(station,phase) #Default output filename
    elif switch is 'off':
        default_out = '/Users/ja17375/DiscrePy/Python/Measurements/{}_{}_Splitting_JW_Windows.txt'.format(station,phase)
    ...
    if os.path.isfile(default_out):
        ...
        if ovr == 'y':
            ...
            outfile = open('/Users/ja17375/DiscrePy/Python/Measurements/{}.txt'.format(new_out),'w+')
...
def save_sac(st,qual,date,time,wbeg,wend,switch):
    ...
    if switch == 'on':
        for tr in st:
            ...
            path = '/Users/ja17375/DiscrePy/Python/Data/Proccessed_Streams'
